...
<div class="inner">
    <h1 class="form-top-title" style="text-align:-webkit-center;">변호사인 제가 직접 안내드립니다</h1>
            ...
            <br>
                <table class="form-box-tb">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='text' name='entry.2085569052' id='name' class="form-control" placeholder="성함" maxlength="4">
                        </td>
                    </tr>
                    <tr>
                        <th><!--<i class="fa fa-phone" aria-hidden="true"></i>-->연락처</th>
                        <td>
                            <input type='text' name='entry.599870854' id='phone' class="form-control" placeholder="휴대폰번호" maxlength="11">
                        </td>
                    </tr>
                    <tr>
                        <!-- <th>지역</th>
                    ...
                    <tr>
                        <td colspan="2" style="border-bottom: none"> 
                            ...
                            <input class="submit-btn" type='submit' id='send_message' value='회생 상담 신청하기' disabled style="background-color: #595858;">
